...
# jazzmin
JAZZMIN_SETTINGS = {
    "site_title": "Merri Garden",  # Заголовок сайта
    "site_header": "Merri Garden",  # Заголовок на экране входа
    "site_brand": "Администрация Merri Garden",  # Выходит на сайте вместо Django-admin.(Администрирование сайта)
    "welcome_sign": "Добро пожаловать в Merri Garden!",  # Приветственный текст на экране входа
    "copyright": "Нурзаман",  # Авторское право (footer)
...
EMAIL_HOST_USER = 'testtingtest6@gmail.com'
EMAIL_HOST_PASSWORD = 'fwwy mrdh ltab wwek'